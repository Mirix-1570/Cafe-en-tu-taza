          ...
          <div className="p-8 sm:p-10">
            <div className="flex flex-col items-center mb-10 text-center">
              <div className="w-16 h-16 bg-[#2f2822] rounded-full flex items-center justify-center mb-5 ring-1 ring-[#3a322b] shadow-inner">
                <span className="material-symbols-outlined text-[#d47211]" style={{ fontSize: 32 }}>person_add</span>
              </div>
              <h2 className="text-2xl font-bold tracking-tight text-white">Crear Cuenta</h2>
              <p className="text-[#9ca3af] text-sm mt-2">Registro de Administrador</p>
            </div>
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-1.5">
                <label className="block text-xs font-bold text-[#b9ab9d] uppercase tracking-wider ml-1">Nombre completo</label>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <span className="material-symbols-outlined text-[#6b5f56] group-focus-within:text-[#d47211] transition-colors" style={{ fontSize: 20 }}>person</span>
                  </div>
                  <input className="block w-full pl-11 pr-4 py-3 bg-[#181411] border border-[#393028] rounded-lg text-sm text-white placeholder-[#584f48] focus:outline-none focus:ring-2 focus:ring-[#d47211]/50 focus:border-[#d47211] transition-all duration-200" placeholder="John Doe" type="text" />
                </div>
              </div>
              <div className="space-y-1.5">
