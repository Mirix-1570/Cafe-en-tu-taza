      ...
      {isMenuOpen && (
        <nav className="md:hidden bg-[#221a11] border-b border-solid border-b-[#483623]">
          <ul className="flex flex-col items-center gap-4 py-4">
            <li><a className="text-white text-sm font-medium leading-normal" href="#">Coffee</a></li>
            <li><a className="text-white text-sm font-medium leading-normal" href="#">Community</a></li>
            <li><a className="text-white text-sm font-medium leading-normal" href="#">Contact</a></li>
            <li><a className="text-white text-sm font-medium leading-normal" href="#">Sign In</a></li>
          </ul>
        </nav>
      )}
    </header>
